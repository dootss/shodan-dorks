...
`title:"IPCam Client"` - 61,718 results  
...
`server: VVTK-HTTP-Server` - 16,025 results  
...
`port:1911,4911 product:Niagara` - 9,347 results  
...
`smart install client active` - 7,348 results  
...
`"Android Debug Bridge" "Device" port:5555` - 4,352 results  
...
`http.title:"Index of /"` - 368,722 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 230,323 results  


[Open Lists on Port 80](https://www.shodan.io/search?query=port%3A80%20title%3A%22Index%20of%20/%22)  
`port:80 title:"Index of /"` - 141,536 results  
...
`port:4444 system32` - 1,131 results  
