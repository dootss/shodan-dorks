...
`title:"IPCam Client"` - 56,458 results  
...
`WWW-Authenticate: "Merit LILIN Ent. Co., Ltd."` - 1,152 results  
...
`port:1911,4911 product:Niagara` - 8,968 results  
...
`port:20000 source address` - 897 results  


[PCWorx](https://www.shodan.io/search?query=port%3A1962%20PLC)  
`port:1962 PLC` - 859 results  
...
`kibana content-length:217` - 586 results  
...
`http.title:"Index of /"` - 368,303 results  
...
*last updated at: 2024-03-19 15:15:45*
