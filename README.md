...
`port:44818` - 545,274 results  


[S7](https://www.shodan.io/search?query=port%3A102)  
`port:102` - 529,745 results  
...
`port:2404 asdu address` - 3,106 results  
...
`"root@" port:23 -login -password -name -Session` - 1,852 results  
...
`"HP-ChaiSOE" port:"80"` - 277 results  
...
`http.title:"Index of /"` - 388,750 results  
...
`port:4444 system32` - 1,051 results  
...
*last updated at: 2023-12-21 03:47:52*
