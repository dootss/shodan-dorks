...
`product:"Hikvision IP Camera"` - 2,831,223 results  
...
`title:"IPCam Client"` - 64,669 results  
...
`server: VVTK-HTTP-Server` - 16,665 results  
...
`"in-tank inventory" port:10001` - 6,273 results  
...
`Server: CANON HTTP Server` - 10,558 results  
