...
`product:"Yawcam webcam viewer httpd"` - 535 results  
...
`"Siemens, SIMATIC" port:161` - 2,990 results  
...
`port:"9200" all:elastic` - 29,570 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 6,021 results  
...
`http.title:"- Polycom" "Server: lighttpd"` - 3,608 results  
...
`"Minecraft Server" "protocol 340" port:25565` - 10,826 results  
