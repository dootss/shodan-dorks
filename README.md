...
`"in-tank inventory" port:10001` - 6,164 results  
...
`"authentication disabled" port:5900,5901` - 5,856 results  
...
`"authentication disabled" "RFB 003.008"` - 5,467 results  
...
`http.title:"- Polycom" "Server: lighttpd"` - 3,580 results  
...
`"root@" port:23 -login -password -name -Session` - 588 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 430 results  
...
`http.title:"Index of /"` - 371,908 results  
...
`HACKED-ROUTER-HELP-SOS-HAD-DEFAULT-PASSWORD` - 97 results  
...
`net:175.45.176.0/22,210.52.109.0/24,77.94.35.0/24` - 58 results  
