...
`WWW-Authenticate: "Merit LILIN Ent. Co., Ltd."` - 1,310 results  
...
`webcam has_screenshot:true` - 252 results  
...
`has_screenshot:true IP Webcam` - 126 results  
...
`"authentication disabled" port:5900,5901` - 6,096 results  
...
`"authentication disabled" "RFB 003.008"` - 5,637 results  
...
`"MongoDB Server Information" port:27017` - 110,057 results  
...
`http.title:"Index of /"` - 388,708 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 290,239 results  


[Filezilla FTP](https://www.shodan.io/search?query=filezilla%20port%3A%2221%22)  
`filezilla port:"21"` - 262,531 results  
...
`HACKED-ROUTER-HELP-SOS-HAD-DEFAULT-PASSWORD` - 116 results  
