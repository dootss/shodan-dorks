...
`"authentication disabled" "RFB 003.008"` - 5,383 results  
...
`"root@" port:23 -login -password -name -Session` - 554 results  
...
`http.title:"Index of /"` - 379,337 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 283,080 results  


[Filezilla FTP](https://www.shodan.io/search?query=filezilla%20port%3A%2221%22)  
`filezilla port:"21"` - 257,487 results  
