...
`"authentication disabled" "RFB 003.008"` - 5,779 results  
...
`"Android Debug Bridge" "Device" port:5555` - 4,899 results  
...
`http 200 server epson -upnp` - 2,536 results  
