...
`has_screenshot:true IP Webcam` - 111 results  
...
`"authentication disabled" port:5900,5901` - 5,850 results  
...
`"authentication disabled" "RFB 003.008"` - 5,673 results  
...
`port:9600 response code` - 1,890 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 416 results  
...
`ssl:"Xerox Generic Root"` - 356 results  
...
`"HP-ChaiSOE" port:"80"` - 172 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 249,956 results  


[Open Lists on Port 80](https://www.shodan.io/search?query=port%3A80%20title%3A%22Index%20of%20/%22)  
`port:80 title:"Index of /"` - 147,474 results  
