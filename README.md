...
`"authentication disabled" port:5900,5901` - 5,846 results  
...
`"Siemens, SIMATIC" port:161` - 3,059 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 17,007 results  
...
`http.title:"- Polycom" "Server: lighttpd"` - 3,688 results  
...
`http 200 server epson -upnp` - 2,896 results  
