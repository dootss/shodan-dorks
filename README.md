...
`product:"Hikvision IP Camera"` - 2,791,261 results  
...
`title:"IPCam Client"` - 62,473 results  
...
`server: VVTK-HTTP-Server` - 16,469 results  
...
`"HP-ChaiSOE" port:"80"` - 174 results  
...
`http.title:"dashboard"` - 254,897 results  
...
`"Minecraft Server" "protocol 340" port:25565` - 11,036 results  
