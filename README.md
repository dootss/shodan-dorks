...
`webcam has_screenshot:true` - 296 results  
...
`"authentication disabled" port:5900,5901` - 5,555 results  
...
`port:9600 response code` - 1,745 results  


[PCWorx](https://www.shodan.io/search?query=port%3A1962%20PLC)  
`port:1962 PLC` - 885 results  
...
`http.title:"- Polycom" "Server: lighttpd"` - 4,029 results  
...
`"root@" port:23 -login -password -name -Session` - 1,927 results  
...
`title:"Weave Scope" http.favicon.hash:567176827` - 41 results  
...
`http.title:"Index of /"` - 385,158 results  
...
`http.title:"dashboard"` - 105,772 results  
...
`"Minecraft Server" "protocol 340" port:25565` - 12,178 results  


[Tesla-related Interfaces](https://www.shodan.io/search?query=http.title%3A%22Tesla%22)  
`http.title:"Tesla"` - 588 results  
...
*last updated at: 2024-01-25 07:27:12*
