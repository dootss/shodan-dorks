...
`title:"IPCam Client"` - 59,637 results  
...
`server: VVTK-HTTP-Server` - 15,399 results  
...
`port:20000 source address` - 1,009 results  


[PCWorx](https://www.shodan.io/search?query=port%3A1962%20PLC)  
`port:1962 PLC` - 975 results  
...
`kibana content-length:217` - 532 results  
...
`http.title:"Index of /"` - 364,450 results  
...
`hacked-router-help-sos` - 734 results  
