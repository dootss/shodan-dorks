...
`"authentication disabled" "RFB 003.008"` - 5,859 results  
...
`"authentication disabled" port:5900,5901` - 5,779 results  
...
`port:2404 asdu address` - 3,550 results  
...
`port:9600 response code` - 1,867 results  
...
`http.title:"control panel"` - 65,185 results  
