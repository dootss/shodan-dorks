...
`"authentication disabled" port:5900,5901` - 6,097 results  
...
`"in-tank inventory" port:10001` - 5,881 results  
...
`port:2404 asdu address` - 3,349 results  
...
`"DICOM Server Response" port:104` - 1,793 results  


[Omron FINS](https://www.shodan.io/search?query=port%3A9600%20response%20code)  
`port:9600 response code` - 1,784 results  
...
`port:5006,5007 product:mitsubishi` - 279 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 7,313 results  


[Cisco Smart Install](https://www.shodan.io/search?query=smart%20install%20client%20active)  
`smart install client active` - 6,809 results  
...
`"Citrix Applications:" port:1604` - 306 results  
