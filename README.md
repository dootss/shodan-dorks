...
`"authentication disabled" "RFB 003.008"` - 6,950 results  
...
`filezilla port:"21"` - 254,916 results  
...
`"220" "230 Login successful." port:21` - 62,964 results  
