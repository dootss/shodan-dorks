...
`200 ok dvr port:"81"` - 9,905 results  
...
`port:9600 response code` - 1,998 results  
...
`"Polycom Command Shell" -failed port:23` - 38 results  
...
`http.title:"dashboard"` - 353,440 results  
