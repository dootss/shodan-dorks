...
`port:20000 source address` - 999 results  
...
`kibana content-length:217` - 544 results  
...
`port:80 title:"Index of /"` - 138,812 results  
...
`"Anonymous access allowed" port:"21"` - 32,325 results  
