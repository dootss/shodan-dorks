...
`title:"IPCam Client"` - 56,989 results  
...
`port:2404 asdu address` - 3,027 results  
...
`"MongoDB Server Information" port:27017` - 96,137 results  


[Default MongoDB Instances](https://www.shodan.io/search?query=mongodb%20port%3A27017)  
`mongodb port:27017` - 96,134 results  
...
`"Android Debug Bridge" "Device" port:5555` - 2,856 results  
...
`"root@" port:23 -login -password -name -Session` - 877 results  
...
`"HP-ChaiSOE" port:"80"` - 184 results  
...
`"220" "230 Login successful." port:21` - 58,173 results  
...
`http.title:"dashboard"` - 108,951 results  
...
*last updated at: 2024-03-23 04:37:39*
