...
`Netwave IP Camera Content-Length: 2574` - 1,302 results  
...
`"authentication disabled" "RFB 003.008"` - 5,340 results  
...
`kibana content-length:217` - 558 results  
...
`"root@" port:23 -login -password -name -Session` - 523 results  
...
`http.title:"Index of /"` - 379,510 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 275,573 results  


[Filezilla FTP](https://www.shodan.io/search?query=filezilla%20port%3A%2221%22)  
`filezilla port:"21"` - 256,504 results  
...
`port:4444 system32` - 1,250 results  
