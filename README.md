...
`title:"IPCam Client"` - 54,833 results  
...
`WWW-Authenticate: "Merit LILIN Ent. Co., Ltd."` - 1,133 results  
...
`port:1911,4911 product:Niagara` - 8,788 results  
...
`port:2404 asdu address` - 2,977 results  
...
`port:9600 response code` - 1,632 results  


[DNP3](https://www.shodan.io/search?query=port%3A20000%20source%20address)  
`port:20000 source address` - 931 results  
...
`"MongoDB Server Information" port:27017` - 96,353 results  


[Default MongoDB Instances](https://www.shodan.io/search?query=mongodb%20port%3A27017)  
`mongodb port:27017` - 96,351 results  
...
`Lantronix password port:30718 -secured` - 620 results  
...
`title:"syncthru web service"` - 921 results  
...
`port:4444 system32` - 1,064 results  
...
`http.title:"dashboard"` - 106,997 results  
