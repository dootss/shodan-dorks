...
`"in-tank inventory" port:10001` - 5,974 results  
...
`"authentication disabled" port:5900,5901` - 5,472 results  
...
`"Siemens, SIMATIC" port:161` - 3,157 results  
...
`port:9600 response code` - 1,783 results  


[PCWorx](https://www.shodan.io/search?query=port%3A1962%20PLC)  
`port:1962 PLC` - 955 results  
...
`kibana content-length:217` - 631 results  
...
*last updated at: 2024-02-28 02:47:25*
