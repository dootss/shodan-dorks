...
`"in-tank inventory" port:10001` - 6,038 results  
...
`"authentication disabled" port:5900,5901` - 5,674 results  
...
`"Siemens, SIMATIC" port:161` - 3,019 results  
...
`port:9600 response code` - 1,736 results  


[PCWorx](https://www.shodan.io/search?query=port%3A1962%20PLC)  
`port:1962 PLC` - 942 results  
...
`"HID VertX" port:4070` - 204 results  
...
`"root@" port:23 -login -password -name -Session` - 1,918 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 1,315 results  
...
`title:"Weave Scope" http.favicon.hash:567176827` - 51 results  
...
`http.title:"Index of /"` - 382,347 results  
...
`HACKED-ROUTER-HELP-SOS-HAD-DEFAULT-PASSWORD` - 147 results  
...
*last updated at: 2024-01-08 15:40:56*
