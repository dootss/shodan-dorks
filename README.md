...
`port:1911,4911 product:Niagara` - 8,804 results  
...
`"authentication disabled" port:5900,5901` - 4,850 results  
...
`"Siemens, SIMATIC" port:161` - 2,731 results  
...
`port:20000 source address` - 933 results  
...
`port:"9200" all:elastic` - 28,371 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 6,506 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 157,537 results  


[Open Lists on Port 80](https://www.shodan.io/search?query=port%3A80%20title%3A%22Index%20of%20/%22)  
`port:80 title:"Index of /"` - 137,814 results  
...
`"Minecraft Server" "protocol 340" port:25565` - 10,488 results  
