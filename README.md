...
`200 ok dvr port:"81"` - 9,896 results  
...
`"MongoDB Server Information" port:27017` - 106,262 results  


[Default MongoDB Instances](https://www.shodan.io/search?query=mongodb%20port%3A27017)  
`mongodb port:27017` - 106,260 results  
...
`http.title:"dashboard"` - 250,519 results  
