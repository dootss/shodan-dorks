...
`port:1911,4911 product:Niagara` - 8,917 results  
...
`port:9600 response code` - 1,666 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 157,836 results  


[Open Lists on Port 80](https://www.shodan.io/search?query=port%3A80%20title%3A%22Index%20of%20/%22)  
`port:80 title:"Index of /"` - 139,123 results  
...
`"Anonymous access allowed" port:"21"` - 31,012 results  
...
*last updated at: 2024-03-28 00:09:46*
