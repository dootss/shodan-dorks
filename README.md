...
`product:"Yawcam webcam viewer httpd"` - 685 results  
...
`webcam has_screenshot:true` - 245 results  
...
`"in-tank inventory" port:10001` - 6,340 results  
...
`"authentication disabled" port:5900,5901` - 6,027 results  
...
`"authentication disabled" "RFB 003.008"` - 5,604 results  
...
`[1m[35mWelcome on console` - 76 results  
...
`smart install client active` - 7,715 results  
...
`kibana content-length:217` - 571 results  
...
`"Citrix Applications:" port:1604` - 298 results  
...
`"Server: EPSON-HTTP" "200 OK"` - 347 results  
...
`http.title:"Index of /"` - 386,296 results  
...
`HACKED-ROUTER-HELP-SOS-HAD-DEFAULT-PASSWORD` - 115 results  
...
`net:175.45.176.0/22,210.52.109.0/24,77.94.35.0/24` - 63 results  
