...
`title:"IPCam Client"` - 58,576 results  
...
`port:1911,4911 product:Niagara` - 9,231 results  
...
`port:2404 asdu address` - 3,353 results  
...
`"MongoDB Server Information" port:27017` - 102,870 results  
...
`"dnsmasq-pi-hole" "Recursion: enabled"` - 2,829 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 377 results  
...
`Server: CANON HTTP Server` - 9,569 results  
...
`http.title:"Index of /"` - 360,690 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 199,264 results  
...
`hacked-router-help-sos` - 735 results  
...
`http.title:"dashboard"` - 114,619 results  
