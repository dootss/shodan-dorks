...
`"authentication disabled" "RFB 003.008"` - 6,851 results  
...
`"authentication disabled" port:5900,5901` - 6,231 results  
...
`mongodb port:27017` - 103,161 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 10,775 results  
...
`http.title:"- Polycom" "Server: lighttpd"` - 3,601 results  
...
`http 200 server epson -upnp` - 1,925 results  
...
`filezilla port:"21"` - 252,417 results  
...
`http.title:"control panel"` - 63,837 results  
