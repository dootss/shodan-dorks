...
`Netwave IP Camera Content-Length: 2574` - 1,252 results  
...
`"authentication disabled" "RFB 003.008"` - 5,441 results  
...
`"root@" port:23 -login -password -name -Session` - 541 results  
...
`http.title:"Index of /"` - 371,394 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 291,917 results  


[Filezilla FTP](https://www.shodan.io/search?query=filezilla%20port%3A%2221%22)  
`filezilla port:"21"` - 255,112 results  
...
`port:4444 system32` - 1,254 results  
