...
`"authentication disabled" "RFB 003.008"` - 5,636 results  
...
`"Siemens, SIMATIC" port:161` - 2,920 results  
...
`port:20000 source address` - 1,005 results  


[PCWorx](https://www.shodan.io/search?query=port%3A1962%20PLC)  
`port:1962 PLC` - 971 results  
...
`http 200 server epson -upnp` - 1,968 results  
