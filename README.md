...
`"authentication disabled" port:5900,5901` - 5,692 results  
...
`"Siemens, SIMATIC" port:161` - 2,871 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 6,664 results  
...
`"root@" port:23 -login -password -name -Session` - 486 results  
...
`http 200 server epson -upnp` - 1,853 results  
