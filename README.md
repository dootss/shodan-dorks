...
`product:"Yawcam webcam viewer httpd"` - 670 results  
...
`port:44818` - 547,536 results  


[Modbus](https://www.shodan.io/search?query=port%3A502)  
`port:502` - 518,896 results  
...
`"authentication disabled" port:5900,5901` - 5,937 results  
...
`"authentication disabled" "RFB 003.008"` - 5,512 results  
...
`kibana content-length:217` - 565 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 437 results  
...
`PBX "gateway console" -password port:23` - 216 results  
...
`"HP-ChaiSOE" port:"80"` - 162 results  
...
`http.title:"Index of /"` - 383,285 results  
...
`http.title:"Hacked by"` - 535 results  
