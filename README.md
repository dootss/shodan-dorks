...
`title:"IPCam Client"` - 59,907 results  
...
`server: VVTK-HTTP-Server` - 15,204 results  
...
`port:2404 asdu address` - 3,463 results  
...
`port:20000 source address` - 1,006 results  


[PCWorx](https://www.shodan.io/search?query=port%3A1962%20PLC)  
`port:1962 PLC` - 978 results  
...
`"Android Debug Bridge" "Device" port:5555` - 5,077 results  


[Listed Apache CouchDB](https://www.shodan.io/search?query=product%3A%22CouchDB%22)  
`product:"CouchDB"` - 4,683 results  
