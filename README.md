...
`"Server: EIG Embedded Web Server" "200 Document follows"` - 301 results
<br>
...
`port:5006,5007 product:mitsubishi` - 214 results
...
`"Server: gSOAP/2.8" "Content-Length: 583"` - 12 results
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 2,014 results
...
`Lantronix password port:30718 -secured` - 513 results
...
`"Set-Cookie: mongo-express=" "200 OK"` - 278 results
...
`"Location: /main/main.html" debut` - 52 results
...
`HACKED-ROUTER-HELP-SOS-HAD-DEFAULT-PASSWORD` - 70 results

[Compromised FTP Servers](https://www.shodan.io/search?query=HACKED%20FTP%20server)  
`HACKED FTP server` - 45 results
...
`net:175.45.176.0/22,210.52.109.0/24,77.94.35.0/24` - 37 results
...
*last updated at: 2025-05-24 14:42:57*
