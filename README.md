...
`"in-tank inventory" port:10001` - 5,888 results  
...
`"root@" port:23 -login -password -name -Session` - 537 results  
...
`"220" "230 Login successful." port:21` - 61,083 results  
