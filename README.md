...
`title:"IPCam Client"` - 63,304 results  
...
`server: VVTK-HTTP-Server` - 17,094 results  
...
`WWW-Authenticate: "Merit LILIN Ent. Co., Ltd."` - 1,327 results  
...
`port:44818` - 542,560 results  


[S7](https://www.shodan.io/search?query=port%3A102)  
`port:102` - 528,545 results  
...
`"HP-ChaiSOE" port:"80"` - 258 results  
...
`http.title:"Index of /"` - 386,397 results  
...
*last updated at: 2023-12-21 11:05:29*
