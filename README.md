...
`200 ok dvr port:"81"` - 10,347 results  
...
`"MongoDB Server Information" port:27017` - 109,362 results  


[Default MongoDB Instances](https://www.shodan.io/search?query=mongodb%20port%3A27017)  
`mongodb port:27017` - 109,360 results  
...
`"dnsmasq-pi-hole" "Recursion: enabled"` - 3,128 results  
...
`http.title:"dashboard"` - 318,311 results  
