...
`"Server: EIG Embedded Web Server" "200 Document follows"` - 268,600 results
<br>
...
`"authentication disabled" "RFB 003.008"` - 180,214 results
<br>
...
`"DICOM Server Response" port:104` - 2,377 results
...
`port:20000 source address` - 1,527 results

[ProConOS](https://www.shodan.io/search?query=port%3A20547%20PLC)  
`port:20547 PLC` - 1,054 results
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 1,913 results
...
`Lantronix password port:30718 -secured` - 484 results
...
`"Citrix Applications:" port:1604` - 159 results
...
`Laser Printer FTP Server` - 26 results
...
`http.title:"Index of /"` - 303,752 results
...
`http.title:"dashboard"` - 409,591 results
...
`"Server: Bomgar" "200 OK"` - 329 results
...
*last updated at: 2025-07-19 13:11:31*
