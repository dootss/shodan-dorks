...
`product:"Yawcam webcam viewer httpd"` - 660 results  
...
`port:9600 response code` - 1,937 results  
...
`port:"9200" all:elastic` - 31,855 results  
...
`"Minecraft Server" "protocol 340" port:25565` - 11,084 results  
