...
`port:5006,5007 product:mitsubishi` - 278 results  
...
`mongodb port:27017` - 103,395 results  
...
`"Server: EPSON-HTTP" "200 OK"` - 324 results  
...
`"Minecraft Server" "protocol 340" port:25565` - 11,134 results  
