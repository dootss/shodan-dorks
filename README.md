...
`product:"Hikvision IP Camera"` - 2,786,462 results  
...
`title:"IPCam Client"` - 62,527 results  
...
`server: VVTK-HTTP-Server` - 16,437 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 254,039 results  
...
`hacked-router-help-sos` - 796 results  
