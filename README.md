...
`server: "i-Catcher Console"` - 38 results  
...
`port:2404 asdu address` - 3,436 results  
...
`port:9600 response code` - 1,822 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 375 results  
...
`ssl:"Xerox Generic Root"` - 368 results  
