...
`port:"9200" all:elastic` - 32,144 results  
...
`"dnsmasq-pi-hole" "Recursion: enabled"` - 3,134 results  
...
`"Minecraft Server" "protocol 340" port:25565` - 11,305 results  
