...
`200 ok dvr port:"81"` - 9,597 results  
...
`webcam has_screenshot:true` - 182 results  
...
`"authentication disabled" port:5900,5901` - 6,043 results  
...
`"Siemens, SIMATIC" port:161` - 3,123 results  


[Omron FINS](https://www.shodan.io/search?query=port%3A9600%20response%20code)  
`port:9600 response code` - 1,967 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 16,253 results  


[Cisco Smart Install](https://www.shodan.io/search?query=smart%20install%20client%20active)  
`smart install client active` - 8,086 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 428 results  
...
`"220" "230 Login successful." port:21` - 60,873 results  
...
`hacked-router-help-sos` - 818 results  
