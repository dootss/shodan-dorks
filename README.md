...
`port:"9200" all:elastic` - 31,489 results  
...
`"dnsmasq-pi-hole" "Recursion: enabled"` - 3,105 results  
...
`port:80 title:"Index of /"` - 152,139 results  
...
`"Minecraft Server" "protocol 340" port:25565` - 11,086 results  
