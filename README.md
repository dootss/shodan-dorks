...
`WWW-Authenticate: "Merit LILIN Ent. Co., Ltd."` - 1,221 results  
...
`port:1911,4911 product:Niagara` - 9,396 results  
...
`"authentication disabled" port:5900,5901` - 6,410 results  
...
`port:2404 asdu address` - 3,514 results  
...
`port:9600 response code` - 1,863 results  
...
`port:20000 source address` - 1,014 results  


[PCWorx](https://www.shodan.io/search?query=port%3A1962%20PLC)  
`port:1962 PLC` - 991 results  
...
`http.title:"- Polycom" "Server: lighttpd"` - 3,662 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 381 results  
...
`Server: CANON HTTP Server` - 9,861 results  
...
`http.title:"Index of /"` - 370,481 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 215,147 results  


[Open Lists on Port 80](https://www.shodan.io/search?query=port%3A80%20title%3A%22Index%20of%20/%22)  
`port:80 title:"Index of /"` - 143,132 results  
