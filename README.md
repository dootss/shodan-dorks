...
`"authentication disabled" port:5900,5901` - 6,204 results  
...
`"Siemens, SIMATIC" port:161` - 3,101 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 6,988 results  
...
`PBX "gateway console" -password port:23` - 192 results  
...
`http.title:"control panel"` - 63,582 results  
