...
`product:"Yawcam webcam viewer httpd"` - 667 results  
...
`port:"9200" all:elastic` - 31,800 results  
...
`"dnsmasq-pi-hole" "Recursion: enabled"` - 3,101 results  
...
`"Minecraft Server" "protocol 340" port:25565` - 11,142 results  
