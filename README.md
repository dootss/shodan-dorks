...
`200 ok dvr port:"81"` - 9,876 results  
...
`"MongoDB Server Information" port:27017` - 106,088 results  


[Default MongoDB Instances](https://www.shodan.io/search?query=mongodb%20port%3A27017)  
`mongodb port:27017` - 106,087 results  
...
`http.title:"dashboard"` - 229,614 results  
