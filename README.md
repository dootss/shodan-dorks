...
`"authentication disabled" "RFB 003.008"` - 5,667 results  
...
`port:2404 asdu address` - 3,485 results  
...
`port:9600 response code` - 1,893 results  
...
`port:20000 source address` - 985 results  
...
`kibana content-length:217` - 548 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 414 results  
