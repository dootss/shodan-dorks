...
`200 ok dvr port:"81"` - 9,779 results  
...
`"MongoDB Server Information" port:27017` - 105,884 results  


[Default MongoDB Instances](https://www.shodan.io/search?query=mongodb%20port%3A27017)  
`mongodb port:27017` - 105,806 results  
...
`http.title:"dashboard"` - 244,444 results  
