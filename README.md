...
`"authentication disabled" port:5900,5901` - 5,931 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 14,982 results  
...
`"root@" port:23 -login -password -name -Session` - 619 results  
...
`"Anonymous access allowed" port:"21"` - 33,609 results  
