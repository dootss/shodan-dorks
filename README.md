...
`port:44818` - 554,718 results  


[S7](https://www.shodan.io/search?query=port%3A102)  
`port:102` - 529,941 results  
...
`"authentication disabled" "RFB 003.008"` - 6,631 results  
...
`"Siemens, SIMATIC" port:161` - 2,969 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 1,356 results  
...
`http.title:"Index of /"` - 382,345 results  
...
`http.title:"Hacked by"` - 828 results  
...
*last updated at: 2024-01-15 01:09:12*
