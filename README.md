...
`product:"Yawcam webcam viewer httpd"` - 659 results  
...
`port:5006,5007 product:mitsubishi` - 233 results  
...
`port:"9200" all:elastic` - 31,957 results  
...
`"Minecraft Server" "protocol 340" port:25565` - 11,116 results  
