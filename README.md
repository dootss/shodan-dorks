...
`product:"Hikvision IP Camera"` - 2,810,774 results  
...
`"authentication disabled" port:5900,5901` - 5,728 results  
...
`port:20000 source address` - 1,072 results  
...
`PBX "gateway console" -password port:23` - 197 results  
...
`ssl:"Xerox Generic Root"` - 391 results  
...
`hacked-router-help-sos` - 812 results  
