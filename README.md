...
`"authentication disabled" port:5900,5901` - 6,243 results  
...
`"in-tank inventory" port:10001` - 5,924 results  
...
`port:2404 asdu address` - 3,386 results  
...
`port:9600 response code` - 1,821 results  
...
`[1m[35mWelcome on console` - 84 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 10,838 results  


[Cisco Smart Install](https://www.shodan.io/search?query=smart%20install%20client%20active)  
`smart install client active` - 6,982 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 204,881 results  
