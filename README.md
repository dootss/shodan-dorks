...
`port:20000 source address` - 898 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 151,028 results  


[Open Lists on Port 80](https://www.shodan.io/search?query=port%3A80%20title%3A%22Index%20of%20/%22)  
`port:80 title:"Index of /"` - 137,951 results  
...
`"Anonymous access allowed" port:"21"` - 30,610 results  
...
*last updated at: 2024-03-29 02:10:48*
