...
`port:1911,4911 product:Niagara` - 8,789 results  
...
`port:"9200" all:elastic` - 28,387 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 152,404 results  


[Open Lists on Port 80](https://www.shodan.io/search?query=port%3A80%20title%3A%22Index%20of%20/%22)  
`port:80 title:"Index of /"` - 138,209 results  
...
`"Anonymous access allowed" port:"21"` - 30,740 results  
...
*last updated at: 2024-03-29 15:42:50*
