...
`title:"IPCam Client"` - 62,490 results  
...
`"authentication disabled" "RFB 003.008"` - 5,277 results  
...
`port:2404 asdu address` - 3,544 results  
...
`port:20000 source address` - 1,068 results  
...
`"MongoDB Server Information" port:27017` - 106,788 results  


[Default MongoDB Instances](https://www.shodan.io/search?query=mongodb%20port%3A27017)  
`mongodb port:27017` - 106,787 results  
...
`"root@" port:23 -login -password -name -Session` - 509 results  
...
`http.title:"Index of /"` - 377,308 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 269,838 results  


[Filezilla FTP](https://www.shodan.io/search?query=filezilla%20port%3A%2221%22)  
`filezilla port:"21"` - 254,974 results  
...
`hacked-router-help-sos` - 807 results  
...
`http.title:"dashboard"` - 322,179 results  
