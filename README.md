...
`"in-tank inventory" port:10001` - 5,915 results  
...
`"root@" port:23 -login -password -name -Session` - 569 results  
...
`"220" "230 Login successful." port:21` - 61,994 results  
...
`port:4444 system32` - 1,140 results  
