...
`port:1911,4911 product:Niagara` - 8,932 results  
...
`port:9600 response code` - 1,683 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 170,433 results  


[Open Lists on Port 80](https://www.shodan.io/search?query=port%3A80%20title%3A%22Index%20of%20/%22)  
`port:80 title:"Index of /"` - 136,097 results  
...
`"Anonymous access allowed" port:"21"` - 31,425 results  
