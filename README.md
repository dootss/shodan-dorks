...
`WWW-Authenticate: "Merit LILIN Ent. Co., Ltd."` - 1,220 results  
...
`"authentication disabled" "RFB 003.008"` - 6,979 results  
...
`"authentication disabled" port:5900,5901` - 6,384 results  
...
`"in-tank inventory" port:10001` - 6,002 results  
...
`port:2404 asdu address` - 3,490 results  
...
`port:9600 response code` - 1,852 results  
...
`port:20000 source address` - 1,012 results  


[PCWorx](https://www.shodan.io/search?query=port%3A1962%20PLC)  
`port:1962 PLC` - 984 results  
...
`port:5006,5007 product:mitsubishi` - 271 results  
...
`[1m[35mWelcome on console` - 83 results  
...
`ssl:"Xerox Generic Root"` - 369 results  
