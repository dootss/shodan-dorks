...
`port:1911,4911 product:Niagara` - 8,757 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 155,174 results  


[Open Lists on Port 80](https://www.shodan.io/search?query=port%3A80%20title%3A%22Index%20of%20/%22)  
`port:80 title:"Index of /"` - 137,614 results  
...
`"Anonymous access allowed" port:"21"` - 30,763 results  
...
*last updated at: 2024-04-02 14:24:46*
