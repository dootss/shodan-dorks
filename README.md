...
`title:"IPCam Client"` - 59,878 results  
...
`port:1911,4911 product:Niagara` - 9,309 results  
...
`port:2404 asdu address` - 3,457 results  
...
`port:9600 response code` - 1,831 results  
...
`"MongoDB Server Information" port:27017` - 104,115 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 376 results  
...
`Server: CANON HTTP Server` - 9,706 results  
...
`http.title:"Index of /"` - 367,345 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 209,189 results  


[Open Lists on Port 80](https://www.shodan.io/search?query=port%3A80%20title%3A%22Index%20of%20/%22)  
`port:80 title:"Index of /"` - 142,630 results  
...
`hacked-router-help-sos` - 760 results  
...
`http.title:"dashboard"` - 127,934 results  
