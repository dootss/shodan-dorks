...
`"authentication disabled" "RFB 003.008"` - 6,925 results  
...
`"authentication disabled" port:5900,5901` - 5,943 results  
...
`"Siemens, SIMATIC" port:161` - 3,038 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 7,055 results  
...
`http 200 server epson -upnp` - 1,951 results  
...
`filezilla port:"21"` - 248,694 results  
...
`http.title:"control panel"` - 62,436 results  
