...
`product:"Yawcam webcam viewer httpd"` - 506 results  
...
`"authentication disabled" "RFB 003.008"` - 6,614 results  
...
`"authentication disabled" port:5900,5901` - 5,681 results  
...
`"in-tank inventory" port:10001` - 5,559 results  
...
`"root@" port:23 -login -password -name -Session` - 474 results  
...
`port:4444 system32` - 1,067 results  
...
`hacked-router-help-sos` - 668 results  
