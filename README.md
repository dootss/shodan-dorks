...
`200 ok dvr port:"81"` - 10,260 results  
...
`port:44818` - 550,070 results  


[Modbus](https://www.shodan.io/search?query=port%3A502)  
`port:502` - 520,086 results  
...
`"authentication disabled" port:5900,5901` - 6,005 results  
...
`"authentication disabled" "RFB 003.008"` - 5,573 results  
...
`"MongoDB Server Information" port:27017` - 108,939 results  
...
`kibana content-length:217` - 568 results  
...
`http.title:"Index of /"` - 385,306 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 280,749 results  


[Filezilla FTP](https://www.shodan.io/search?query=filezilla%20port%3A%2221%22)  
`filezilla port:"21"` - 260,530 results  
...
`"220" "230 Login successful." port:21` - 63,849 results  
