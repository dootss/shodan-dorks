...
`"authentication disabled" port:5900,5901` - 5,829 results  
...
`"authentication disabled" "RFB 003.008"` - 5,595 results  
...
`port:2404 asdu address` - 3,555 results  
...
`port:20000 source address` - 988 results  
...
`http.title:"Index of /"` - 378,465 results  
