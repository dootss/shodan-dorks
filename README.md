...
`title:"IPCam Client"` - 62,239 results  
...
`server: VVTK-HTTP-Server` - 15,938 results  
...
`port:1911,4911 product:Niagara` - 9,374 results  
...
`port:9600 response code` - 1,879 results  
...
`port:20000 source address` - 1,029 results  


[PCWorx](https://www.shodan.io/search?query=port%3A1962%20PLC)  
`port:1962 PLC` - 1,021 results  
...
`http.title:"Index of /"` - 370,626 results  
...
`hacked-router-help-sos` - 779 results  
