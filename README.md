...
`"authentication disabled" "RFB 003.008"` - 5,542 results  
...
`port:23 "Password is not set"` - 420 results  
...
`http.title:"Index of /"` - 384,290 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 277,635 results  


[Filezilla FTP](https://www.shodan.io/search?query=filezilla%20port%3A%2221%22)  
`filezilla port:"21"` - 259,861 results  
