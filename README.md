...
`title:"IPCam Client"` - 58,221 results  
...
`"MongoDB Server Information" port:27017` - 101,316 results  


[Default MongoDB Instances](https://www.shodan.io/search?query=mongodb%20port%3A27017)  
`mongodb port:27017` - 101,315 results  
...
`smart install client active` - 6,909 results  
...
`"220" "230 Login successful." port:21` - 60,981 results  
...
`port:4444 system32` - 1,144 results  
...
`http.title:"dashboard"` - 110,036 results  
