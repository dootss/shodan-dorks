...
`title:"IPCam Client"` - 62,818 results  
...
`server: VVTK-HTTP-Server` - 16,393 results  
...
`has_screenshot:true IP Webcam` - 110 results  
...
`port:1911,4911 product:Niagara` - 9,413 results  
...
`port:2404 asdu address` - 3,517 results  
...
`port:20000 source address` - 1,017 results  
...
`"MongoDB Server Information" port:27017` - 106,160 results  


[Default MongoDB Instances](https://www.shodan.io/search?query=mongodb%20port%3A27017)  
`mongodb port:27017` - 106,157 results  
...
`"dnsmasq-pi-hole" "Recursion: enabled"` - 3,079 results  
...
`http.title:"Index of /"` - 370,596 results  
...
`hacked-router-help-sos` - 793 results  
...
`http.title:"dashboard"` - 217,446 results  
