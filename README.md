...
`title:"IPCam Client"` - 57,827 results  
...
`200 ok dvr port:"81"` - 9,000 results  
...
`port:1911,4911 product:Niagara` - 9,130 results  
...
`"MongoDB Server Information" port:27017` - 101,248 results  


[Default MongoDB Instances](https://www.shodan.io/search?query=mongodb%20port%3A27017)  
`mongodb port:27017` - 101,246 results  
...
`"Android Debug Bridge" "Device" port:5555` - 4,354 results  
...
`"dnsmasq-pi-hole" "Recursion: enabled"` - 2,707 results  
...
`Server: CANON HTTP Server` - 9,385 results  
...
`title:"syncthru web service"` - 961 results  
...
`http.title:"Index of /"` - 358,878 results  
...
`hacked-router-help-sos` - 716 results  
...
`http.title:"dashboard"` - 110,665 results  
