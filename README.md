...
`port:1911,4911 product:Niagara` - 8,869 results  
...
`port:9600 response code` - 1,644 results  


[DNP3](https://www.shodan.io/search?query=port%3A20000%20source%20address)  
`port:20000 source address` - 909 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 156,090 results  


[Open Lists on Port 80](https://www.shodan.io/search?query=port%3A80%20title%3A%22Index%20of%20/%22)  
`port:80 title:"Index of /"` - 138,870 results  
...
`"Anonymous access allowed" port:"21"` - 30,874 results  
...
`http.title:"Hacked by"` - 547 results  
...
*last updated at: 2024-03-27 08:33:17*
