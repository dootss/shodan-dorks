...
`"authentication disabled" port:5900,5901` - 5,777 results  
...
`port:2404 asdu address` - 3,566 results  
...
`port:9600 response code` - 1,908 results  
...
`port:5006,5007 product:mitsubishi` - 226 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 16,871 results  


[Cisco Smart Install](https://www.shodan.io/search?query=smart%20install%20client%20active)  
`smart install client active` - 7,584 results  
...
`"dnsmasq-pi-hole" "Recursion: enabled"` - 3,095 results  
...
`"root@" port:23 -login -password -name -Session` - 545 results  
...
`ssl:"Xerox Generic Root"` - 344 results  
...
`http.title:"Index of /"` - 376,736 results  
