...
`"Server: EIG Embedded Web Server" "200 Document follows"` - 131,879 results
<br>
...
`port:20000 source address` - 1,529 results

[ProConOS](https://www.shodan.io/search?query=port%3A20547%20PLC)  
`port:20547 PLC` - 1,088 results
...
`port:5006,5007 product:mitsubishi` - 219 results
...
`[1m[35mWelcome on console` - 31 results
<br>
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 2,012 results
...
`"Citrix Applications:" port:1604` - 176 results
...
`"Docker-Distribution-Api-Version: registry" "200 OK" -gitlab` - 164 results

[Telnet Configuration](https://www.shodan.io/search?query=%22Polycom%20Command%20Shell%22%20-failed%20port%3A23)  
`"Polycom Command Shell" -failed port:23` - 22 results
...
`Printer Type: Lexmark` - 127 results
...
`http.title:"Hacked by"` - 413 results
...
`http.title:"dashboard"` - 349,012 results
...
*last updated at: 2025-06-14 10:50:24*
