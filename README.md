...
`200 ok dvr port:"81"` - 9,602 results  
...
`"authentication disabled" port:5900,5901` - 5,862 results  
...
`"authentication disabled" "RFB 003.008"` - 5,485 results  
...
`port:9600 response code` - 1,950 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 16,235 results  


[Cisco Smart Install](https://www.shodan.io/search?query=smart%20install%20client%20active)  
`smart install client active` - 7,909 results  
...
`http.title:"- Polycom" "Server: lighttpd"` - 3,548 results  
...
`http.title:"Index of /"` - 373,032 results  
