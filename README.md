...
`"in-tank inventory" port:10001` - 6,338 results  
...
`"authentication disabled" port:5900,5901` - 6,067 results  
...
`"authentication disabled" "RFB 003.008"` - 5,647 results  
...
`port:2404 asdu address` - 3,664 results  
...
`port:20000 source address` - 1,131 results  


[PCWorx](https://www.shodan.io/search?query=port%3A1962%20PLC)  
`port:1962 PLC` - 1,111 results  
...
`http.title:"Index of /"` - 377,857 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 309,131 results  


[Filezilla FTP](https://www.shodan.io/search?query=filezilla%20port%3A%2221%22)  
`filezilla port:"21"` - 258,830 results  
...
`"220" "230 Login successful." port:21` - 63,015 results  
...
`http.title:"Hacked by"` - 548 results  
...
`http.title:"control panel"` - 67,573 results  
