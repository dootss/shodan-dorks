...
`title:"IPCam Client"` - 60,319 results  
...
`server: VVTK-HTTP-Server` - 15,127 results  
...
`port:1911,4911 product:Niagara` - 9,332 results  
...
`port:2404 asdu address` - 3,474 results  
...
`port:9600 response code` - 1,842 results  
...
`"MongoDB Server Information" port:27017` - 104,536 results  
...
`Server: CANON HTTP Server` - 9,755 results  
...
`http.title:"Index of /"` - 368,344 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 211,157 results  


[Open Lists on Port 80](https://www.shodan.io/search?query=port%3A80%20title%3A%22Index%20of%20/%22)  
`port:80 title:"Index of /"` - 142,770 results  
...
`http.title:"dashboard"` - 131,203 results  
