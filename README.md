...
`"authentication disabled" port:5900,5901` - 6,125 results  
...
`"in-tank inventory" port:10001` - 5,916 results  
...
`port:20000 source address` - 996 results  


[PCWorx](https://www.shodan.io/search?query=port%3A1962%20PLC)  
`port:1962 PLC` - 934 results  
...
`Lantronix password port:30718 -secured` - 647 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 387 results  
...
`"Polycom Command Shell" -failed port:23` - 47 results  
...
`ssl:"Xerox Generic Root"` - 376 results  
