...
`200 ok dvr port:"81"` - 10,208 results  
...
`port:9600 response code` - 1,994 results  
...
`"dnsmasq-pi-hole" "Recursion: enabled"` - 3,131 results  
...
`http.title:"dashboard"` - 300,298 results  
...
`"Minecraft Server" "protocol 340" port:25565` - 11,216 results  
