...
`"authentication disabled" "RFB 003.008"` - 6,737 results  
...
`"authentication disabled" port:5900,5901` - 6,354 results  
...
`"Siemens, SIMATIC" port:161` - 3,100 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 14,057 results  
...
`filezilla port:"21"` - 254,943 results  
...
`http.title:"control panel"` - 64,353 results  
