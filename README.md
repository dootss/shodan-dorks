...
`product:"Yawcam webcam viewer httpd"` - 602 results  
...
`"authentication disabled" "RFB 003.008"` - 6,346 results  
...
`"authentication disabled" port:5900,5901` - 6,284 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 15,557 results  


[Cisco Smart Install](https://www.shodan.io/search?query=smart%20install%20client%20active)  
`smart install client active` - 7,098 results  
...
`kibana content-length:217` - 530 results  
