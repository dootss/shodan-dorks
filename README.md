...
`title:"IPCam Client"` - 56,058 results  
...
`"in-tank inventory" port:10001` - 5,531 results  
...
`"authentication disabled" port:5900,5901` - 4,923 results  
...
`port:9600 response code` - 1,631 results  


[DNP3](https://www.shodan.io/search?query=port%3A20000%20source%20address)  
`port:20000 source address` - 895 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 6,148 results  


[Listed Apache CouchDB](https://www.shodan.io/search?query=product%3A%22CouchDB%22)  
`product:"CouchDB"` - 4,335 results  
...
`Lantronix password port:30718 -secured` - 638 results  
...
`title:"syncthru web service"` - 926 results  
...
`hacked-router-help-sos` - 652 results  
...
*last updated at: 2024-03-23 06:43:01*
