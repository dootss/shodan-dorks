...
`port:1911,4911 product:Niagara` - 8,929 results  
...
`port:"9200" all:elastic` - 29,053 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 161,877 results  


[Open Lists on Port 80](https://www.shodan.io/search?query=port%3A80%20title%3A%22Index%20of%20/%22)  
`port:80 title:"Index of /"` - 139,958 results  
...
`"Anonymous access allowed" port:"21"` - 31,158 results  
...
*last updated at: 2024-03-25 02:25:44*
