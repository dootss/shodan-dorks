...
`product:"Hikvision IP Camera"` - 2,805,937 results  
...
`title:"IPCam Client"` - 63,112 results  
...
`server: VVTK-HTTP-Server` - 16,532 results  
...
`Server: CANON HTTP Server` - 10,316 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 260,162 results  
...
`"Anonymous access allowed" port:"21"` - 33,235 results  
...
`hacked-router-help-sos` - 815 results  
