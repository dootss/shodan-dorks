...
`server: GeoHttpServer` - 44,163 results  
...
`port:2404 asdu address` - 3,697 results  
...
`"DICOM Server Response" port:104` - 1,893 results  
...
`Server: CANON HTTP Server` - 10,347 results  
...
`http.title:"Index of /"` - 383,472 results  
...
`port:80 title:"Index of /"` - 155,477 results  
...
`"Anonymous access allowed" port:"21"` - 34,062 results  
...
`http.title:"Hacked by"` - 557 results  
