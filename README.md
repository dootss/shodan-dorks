...
`title:"IPCam Client"` - 59,315 results  
...
`WWW-Authenticate: "Merit LILIN Ent. Co., Ltd."` - 1,183 results  
...
`port:1911,4911 product:Niagara` - 9,271 results  
...
`port:2404 asdu address` - 3,398 results  
...
`port:9600 response code` - 1,824 results  
...
`"MongoDB Server Information" port:27017` - 103,568 results  
...
`smart install client active` - 6,987 results  
...
`Server: CANON HTTP Server` - 9,658 results  
...
`http.title:"Index of /"` - 365,548 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 205,552 results  


[Open Lists on Port 80](https://www.shodan.io/search?query=port%3A80%20title%3A%22Index%20of%20/%22)  
`port:80 title:"Index of /"` - 141,985 results  
...
`hacked-router-help-sos` - 752 results  
...
`http.title:"dashboard"` - 121,947 results  
