...
`"in-tank inventory" port:10001` - 5,589 results  
...
`"authentication disabled" port:5900,5901` - 4,797 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 6,420 results  
...
`"Android Debug Bridge" "Device" port:5555` - 2,842 results  
...
`"root@" port:23 -login -password -name -Session` - 720 results  
...
`title:"syncthru web service"` - 918 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 157,687 results  


[Open Lists on Port 80](https://www.shodan.io/search?query=port%3A80%20title%3A%22Index%20of%20/%22)  
`port:80 title:"Index of /"` - 139,251 results  
...
*last updated at: 2024-03-25 08:40:13*
