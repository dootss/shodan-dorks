...
`port:9600 response code` - 1,906 results  
...
`port:"9200" all:elastic` - 31,662 results  
...
`"dnsmasq-pi-hole" "Recursion: enabled"` - 2,980 results  
...
`"Minecraft Server" "protocol 340" port:25565` - 10,955 results  
