...
`title:"IPCam Client"` - 62,633 results  
...
`server: VVTK-HTTP-Server` - 16,534 results  
...
`port:2404 asdu address` - 3,541 results  
...
`port:9600 response code` - 1,904 results  
...
`"dnsmasq-pi-hole" "Recursion: enabled"` - 3,073 results  
...
`http.title:"Index of /"` - 373,922 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 247,187 results  


[Open Lists on Port 80](https://www.shodan.io/search?query=port%3A80%20title%3A%22Index%20of%20/%22)  
`port:80 title:"Index of /"` - 146,018 results  
...
`port:4444 system32` - 1,201 results  
...
`hacked-router-help-sos` - 795 results  
