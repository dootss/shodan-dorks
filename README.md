...
`title:"IPCam Client"` - 55,486 results  
...
`200 ok dvr port:"81"` - 8,226 results  
...
`port:2404 asdu address` - 2,983 results  
...
`"MongoDB Server Information" port:27017` - 95,786 results  


[Default MongoDB Instances](https://www.shodan.io/search?query=mongodb%20port%3A27017)  
`mongodb port:27017` - 95,781 results  
...
`smart install client active` - 6,736 results  
...
`"dnsmasq-pi-hole" "Recursion: enabled"` - 2,583 results  
...
`"220" "230 Login successful." port:21` - 57,210 results  
...
`port:4444 system32` - 1,056 results  
...
`http.title:"dashboard"` - 107,201 results  
