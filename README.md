...
`port:1911,4911 product:Niagara` - 9,214 results  
...
`"authentication disabled" port:5900,5901` - 5,976 results  
...
`"in-tank inventory" port:10001` - 5,923 results  
...
`port:20000 source address` - 998 results  
...
`"MongoDB Server Information" port:27017` - 102,075 results  
...
`port:"9200" all:elastic` - 30,137 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 399 results  
...
`Server: CANON HTTP Server` - 9,507 results  
...
`"Server: EPSON-HTTP" "200 OK"` - 331 results  
...
`http.title:"Index of /"` - 362,094 results  
