...
`title:"IPCam Client"` - 64,153 results  
...
`server: VVTK-HTTP-Server` - 16,621 results  
...
`"authentication disabled" "RFB 003.008"` - 5,454 results  
...
`"MongoDB Server Information" port:27017` - 109,874 results  
...
`"Android Debug Bridge" "Device" port:5555` - 4,564 results  
...
`Server: CANON HTTP Server` - 10,024 results  
...
`http.title:"Index of /"` - 371,959 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 290,321 results  


[Filezilla FTP](https://www.shodan.io/search?query=filezilla%20port%3A%2221%22)  
`filezilla port:"21"` - 253,424 results  
...
`"220" "230 Login successful." port:21` - 62,247 results  
