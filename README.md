...
`product:"Hikvision IP Camera"` - 2,765,727 results  
...
`title:"IPCam Client"` - 62,828 results  
...
`"in-tank inventory" port:10001` - 6,227 results  
...
`port:2404 asdu address` - 3,562 results  
...
`"MongoDB Server Information" port:27017` - 107,508 results  


[Default MongoDB Instances](https://www.shodan.io/search?query=mongodb%20port%3A27017)  
`mongodb port:27017` - 107,505 results  
...
`"dnsmasq-pi-hole" "Recursion: enabled"` - 2,954 results  
...
`"HP-ChaiSOE" port:"80"` - 151 results  
...
`"220" "230 Login successful." port:21` - 61,554 results  
...
`hacked-router-help-sos` - 828 results  
...
`http.title:"dashboard"` - 336,177 results  
