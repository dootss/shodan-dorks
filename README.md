...
`"authentication disabled" port:5900,5901` - 6,054 results  
...
`"authentication disabled" "RFB 003.008"` - 5,656 results  
...
`port:5006,5007 product:mitsubishi` - 244 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 438 results  
...
`"HP-ChaiSOE" port:"80"` - 141 results  
...
`http.title:"Index of /"` - 382,014 results  
...
`http.title:"Hacked by"` - 534 results  
...
`http.title:"dashboard"` - 356,056 results  
...
`"Minecraft Server" "protocol 340" port:25565` - 11,390 results  


[Tesla-related Interfaces](https://www.shodan.io/search?query=http.title%3A%22Tesla%22)  
`http.title:"Tesla"` - 704 results  
