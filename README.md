...
`"Siemens, SIMATIC" port:161` - 3,060 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 10,472 results  


[Cisco Smart Install](https://www.shodan.io/search?query=smart%20install%20client%20active)  
`smart install client active` - 6,968 results  
...
`"root@" port:23 -login -password -name -Session` - 585 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 371 results  
...
`hacked-router-help-sos` - 748 results  
