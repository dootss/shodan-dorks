...
`"authentication disabled" "RFB 003.008"` - 5,406 results  
...
`http.title:"Index of /"` - 375,755 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 291,665 results  


[Filezilla FTP](https://www.shodan.io/search?query=filezilla%20port%3A%2221%22)  
`filezilla port:"21"` - 256,528 results  
