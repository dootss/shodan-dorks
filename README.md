...
`product:"Yawcam webcam viewer httpd"` - 594 results  
...
`"authentication disabled" port:5900,5901` - 5,971 results  
...
`"authentication disabled" "RFB 003.008"` - 5,590 results  
...
`port:2404 asdu address` - 3,608 results  
...
`http.title:"Index of /"` - 378,154 results  
...
`hacked-router-help-sos` - 850 results  
