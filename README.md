...
`product:"Yawcam webcam viewer httpd"` - 515 results  
...
`"authentication disabled" port:5900,5901` - 5,742 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 6,927 results  
...
`http.title:"- Polycom" "Server: lighttpd"` - 3,590 results  
...
`"Minecraft Server" "protocol 340" port:25565` - 10,612 results  
