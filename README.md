...
`"authentication disabled" port:5900,5901` - 5,964 results  
...
`"in-tank inventory" port:10001` - 5,898 results  
...
`"Server: gSOAP/2.8" "Content-Length: 583"` - 29 results  
...
`"Polycom Command Shell" -failed port:23` - 52 results  
...
`"QuickBooks files OverNetwork" -unix port:445` - 40 results  
...
`HACKED-ROUTER-HELP-SOS-HAD-DEFAULT-PASSWORD` - 110 results  


[Compromised FTP Servers](https://www.shodan.io/search?query=HACKED%20FTP%20server)  
`HACKED FTP server` - 60 results  
