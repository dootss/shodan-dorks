...
`product:"Hikvision IP Camera"` - 2,795,208 results  
...
`port:44818` - 542,909 results  


[S7](https://www.shodan.io/search?query=port%3A102)  
`port:102` - 514,960 results  
...
`"authentication disabled" port:5900,5901` - 5,821 results  
...
`"authentication disabled" "RFB 003.008"` - 5,578 results  
...
`port:2404 asdu address` - 3,518 results  
...
`"MongoDB Server Information" port:27017` - 106,211 results  


[Default MongoDB Instances](https://www.shodan.io/search?query=mongodb%20port%3A27017)  
`mongodb port:27017` - 106,209 results  
...
`ssl:"Xerox Generic Root"` - 351 results  
...
`port:4444 system32` - 1,244 results  
...
`http.title:"Hacked by"` - 500 results  
