...
`"in-tank inventory" port:10001` - 6,092 results  
...
`"authentication disabled" port:5900,5901` - 5,769 results  
...
`"MongoDB Server Information" port:27017` - 100,535 results  


[Default MongoDB Instances](https://www.shodan.io/search?query=mongodb%20port%3A27017)  
`mongodb port:27017` - 100,531 results  
...
`smart install client active` - 10,606 results  
...
`"root@" port:23 -login -password -name -Session` - 1,836 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 1,257 results  
...
`Lantronix password port:30718 -secured` - 693 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 496 results  
...
`http.title:"Index of /"` - 383,802 results  
...
`HACKED-ROUTER-HELP-SOS-HAD-DEFAULT-PASSWORD` - 140 results  
...
*last updated at: 2023-12-28 07:07:43*
