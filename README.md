...
`"authentication disabled" port:5900,5901` - 6,160 results  
...
`"authentication disabled" "RFB 003.008"` - 5,813 results  
...
`port:2404 asdu address` - 3,720 results  
...
`port:5006,5007 product:mitsubishi` - 256 results  
...
`kibana content-length:217` - 579 results  
...
`http.title:"Index of /"` - 384,641 results  
