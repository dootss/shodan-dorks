...
`Netwave IP Camera Content-Length: 2574` - 1,277 results  
...
`"authentication disabled" "RFB 003.008"` - 5,323 results  
...
`port:23 "Password is not set"` - 408 results  
...
`http.title:"Index of /"` - 373,537 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 281,612 results  


[Filezilla FTP](https://www.shodan.io/search?query=filezilla%20port%3A%2221%22)  
`filezilla port:"21"` - 255,039 results  
