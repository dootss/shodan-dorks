...
`server: GeoHttpServer` - 42,021 results  
...
`200 ok dvr port:"81"` - 9,666 results  
...
`port:44818` - 593,729 results  


[S7](https://www.shodan.io/search?query=port%3A102)  
`port:102` - 575,231 results  
...
`"authentication disabled" "RFB 003.008"` - 5,531 results  
...
`"MongoDB Server Information" port:27017` - 109,542 results  
...
`port:"9200" all:elastic` - 32,065 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 13,604 results  
...
`"Server: EPSON-HTTP" "200 OK"` - 302 results  
...
`http.title:"Index of /"` - 377,170 results  
