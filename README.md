...
`"in-tank inventory" port:10001` - 5,533 results  
...
`"authentication disabled" port:5900,5901` - 4,723 results  
...
`port:2404 asdu address` - 2,961 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 6,299 results  
...
`Lantronix password port:30718 -secured` - 618 results  
...
`"root@" port:23 -login -password -name -Session` - 450 results  
...
`HACKED-ROUTER-HELP-SOS-HAD-DEFAULT-PASSWORD` - 92 results  


[Compromised FTP Servers](https://www.shodan.io/search?query=HACKED%20FTP%20server)  
`HACKED FTP server` - 54 results  
...
*last updated at: 2024-04-01 08:14:38*
