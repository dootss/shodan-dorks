...
`"authentication disabled" "RFB 003.008"` - 6,999 results  
...
`"authentication disabled" port:5900,5901` - 6,233 results  
...
`"Siemens, SIMATIC" port:161` - 3,086 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 8,535 results  
...
`filezilla port:"21"` - 252,365 results  
