...
`"authentication disabled" "RFB 003.008"` - 5,507 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 17,190 results  
...
`http.title:"- Polycom" "Server: lighttpd"` - 3,709 results  
...
`PBX "gateway console" -password port:23` - 209 results  
...
`ssl:"Xerox Generic Root"` - 380 results  
...
`http.title:"Index of /"` - 383,094 results  
...
`http.title:"control panel"` - 66,627 results  
