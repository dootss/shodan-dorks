...
`product:"Hikvision IP Camera"` - 2,858,548 results  
...
`title:"IPCam Client"` - 64,513 results  
...
`port:502` - 518,157 results  


[S7](https://www.shodan.io/search?query=port%3A102)  
`port:102` - 517,576 results  
...
`mongodb port:27017` - 107,986 results  
...
`"MongoDB Server Information" port:27017` - 107,986 results  
...
`"220" "230 Login successful." port:21` - 63,562 results  
...
`http.title:"dashboard"` - 297,732 results  
