...
`product:"Yawcam webcam viewer httpd"` - 658 results  
...
`"in-tank inventory" port:10001` - 6,103 results  
...
`"authentication disabled" port:5900,5901` - 5,810 results  
...
`"authentication disabled" "RFB 003.008"` - 5,716 results  
...
`"Siemens, SIMATIC" port:161` - 3,021 results  
...
`port:20000 source address` - 1,008 results  
