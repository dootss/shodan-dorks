...
`"authentication disabled" port:5900,5901` - 5,989 results  
...
`"authentication disabled" "RFB 003.008"` - 5,597 results  
...
`port:2404 asdu address` - 3,627 results  
...
`port:9600 response code` - 1,977 results  
...
`Lantronix password port:30718 -secured` - 651 results  
...
`PBX "gateway console" -password port:23` - 222 results  
...
`http.title:"Index of /"` - 376,091 results  
