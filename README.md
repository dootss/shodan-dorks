...
`WWW-Authenticate: "Merit LILIN Ent. Co., Ltd."` - 1,347 results  
...
`"in-tank inventory" port:10001` - 6,078 results  
...
`title:"Slocum Fleet Mission Control"` - 88 results  
...
`"MongoDB Server Information" port:27017` - 101,652 results  


[Default MongoDB Instances](https://www.shodan.io/search?query=mongodb%20port%3A27017)  
`mongodb port:27017` - 101,650 results  
...
`smart install client active` - 10,427 results  
...
`"root@" port:23 -login -password -name -Session` - 1,807 results  
...
`Lantronix password port:30718 -secured` - 734 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 558 results  
...
`"HP-ChaiSOE" port:"80"` - 345 results  
...
`http.title:"Index of /"` - 383,264 results  
...
*last updated at: 2023-12-11 03:00:06*
