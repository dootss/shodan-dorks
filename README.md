...
`"authentication disabled" port:5900,5901` - 6,275 results  
...
`port:2404 asdu address` - 3,424 results  
...
`port:9600 response code` - 1,818 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 10,545 results  


[Cisco Smart Install](https://www.shodan.io/search?query=smart%20install%20client%20active)  
`smart install client active` - 7,010 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 374 results  
