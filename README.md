...
`title:"IPCam Client"` - 55,756 results  
...
`200 ok dvr port:"81"` - 8,286 results  
...
`port:1911,4911 product:Niagara` - 8,743 results  
...
`port:2404 asdu address` - 2,984 results  
...
`port:9600 response code` - 1,627 results  
...
`"MongoDB Server Information" port:27017` - 95,681 results  


[Default MongoDB Instances](https://www.shodan.io/search?query=mongodb%20port%3A27017)  
`mongodb port:27017` - 95,680 results  
...
`smart install client active` - 6,785 results  
...
`"Android Debug Bridge" "Device" port:5555` - 3,021 results  
...
`port:23 "Password is not set"` - 400 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 153,053 results  


[Open Lists on Port 80](https://www.shodan.io/search?query=port%3A80%20title%3A%22Index%20of%20/%22)  
`port:80 title:"Index of /"` - 137,536 results  
...
`http.title:"dashboard"` - 107,441 results  
...
*last updated at: 2024-04-01 15:32:14*
