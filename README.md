...
`"authentication disabled" port:5900,5901` - 4,840 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 6,625 results  
...
`"Minecraft Server" "protocol 340" port:25565` - 10,452 results  
