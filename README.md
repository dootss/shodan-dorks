...
`webcam has_screenshot:true` - 178 results  
...
`"in-tank inventory" port:10001` - 5,890 results  
...
`"220" "230 Login successful." port:21` - 61,824 results  
...
`"QuickBooks files OverNetwork" -unix port:445` - 36 results  
