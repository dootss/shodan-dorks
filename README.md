...
`title:"IPCam Client"` - 63,442 results  
...
`"DICOM Server Response" port:104` - 1,815 results  
...
`"root@" port:23 -login -password -name -Session` - 1,862 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 1,269 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 499 results  
...
`"Server: EPSON-HTTP" "200 OK"` - 398 results  
...
`http.title:"Index of /"` - 384,764 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 276,408 results  


[Filezilla FTP](https://www.shodan.io/search?query=filezilla%20port%3A%2221%22)  
`filezilla port:"21"` - 267,454 results  
...
*last updated at: 2023-12-28 17:32:03*
