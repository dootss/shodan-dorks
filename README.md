...
`port:1911,4911 product:Niagara` - 8,990 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 175,788 results  


[Open Lists on Port 80](https://www.shodan.io/search?query=port%3A80%20title%3A%22Index%20of%20/%22)  
`port:80 title:"Index of /"` - 136,709 results  
...
`"Anonymous access allowed" port:"21"` - 31,665 results  
