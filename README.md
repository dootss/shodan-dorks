...
`title:"IPCam Client"` - 56,306 results  
...
`200 ok dvr port:"81"` - 8,744 results  
...
`WWW-Authenticate: "Merit LILIN Ent. Co., Ltd."` - 1,137 results  
...
`port:2404 asdu address` - 3,138 results  
...
`"MongoDB Server Information" port:27017` - 98,764 results  


[Default MongoDB Instances](https://www.shodan.io/search?query=mongodb%20port%3A27017)  
`mongodb port:27017` - 98,761 results  
...
`smart install client active` - 6,856 results  
...
`port:23 "Password is not set"` - 399 results  
...
`"220" "230 Login successful." port:21` - 59,265 results  
...
`port:4444 system32` - 1,109 results  
...
`hacked-router-help-sos` - 684 results  
...
`http.title:"dashboard"` - 107,984 results  
