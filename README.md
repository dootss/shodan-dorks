...
`product:"Yawcam webcam viewer httpd"` - 517 results  
...
`"authentication disabled" "RFB 003.008"` - 6,607 results  
...
`"authentication disabled" port:5900,5901` - 5,707 results  
...
`"in-tank inventory" port:10001` - 5,673 results  
...
`Server: CANON HTTP Server` - 9,291 results  
...
`port:23 "Password is not set"` - 398 results  
...
`"220" "230 Login successful." port:21` - 59,144 results  
...
`hacked-router-help-sos` - 681 results  
