...
`server: VVTK-HTTP-Server` - 16,876 results  
...
`"authentication disabled" "RFB 003.008"` - 5,432 results  
...
`port:2404 asdu address` - 3,565 results  
...
`port:20000 source address` - 1,096 results  


[PCWorx](https://www.shodan.io/search?query=port%3A1962%20PLC)  
`port:1962 PLC` - 1,062 results  
...
`"HP-ChaiSOE" port:"80"` - 136 results  
...
`http.title:"Index of /"` - 371,094 results  
...
`"Anonymous access allowed" port:"21"` - 33,371 results  
...
`port:4444 system32` - 1,174 results  
