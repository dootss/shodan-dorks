...
`server: "i-Catcher Console"` - 45 results
...
`title:"blue iris remote view"` - 25 results
...
`"Server: EIG Embedded Web Server" "200 Document follows"` - 28,090 results
<br>
...
`"in-tank inventory" port:10001` - 5,300 results
<br>
...
`"DICOM Server Response" port:104` - 2,257 results

[Omron FINS](https://www.shodan.io/search?query=port%3A9600%20response%20code)  
`port:9600 response code` - 1,728 results
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 2,013 results
...
`Lantronix password port:30718 -secured` - 506 results
...
`"Set-Cookie: mongo-express=" "200 OK"` - 271 results
...
`"Minecraft Server" "protocol 340" port:25565` - 6,739 results

[Bitcoin Antminer Miners](https://www.shodan.io/search?query=antminer)  
`antminer` - 1,813 results
<br>
...
*last updated at: 2025-05-31 06:22:42*
