...
`title:"IPCam Client"` - 60,045 results  
...
`WWW-Authenticate: "Merit LILIN Ent. Co., Ltd."` - 1,213 results  
...
`port:1911,4911 product:Niagara` - 9,228 results  
...
`port:9600 response code` - 1,829 results  
...
`port:20000 source address` - 1,013 results  


[PCWorx](https://www.shodan.io/search?query=port%3A1962%20PLC)  
`port:1962 PLC` - 982 results  
...
`"MongoDB Server Information" port:27017` - 103,834 results  
...
`http.title:"Index of /"` - 365,925 results  
...
`hacked-router-help-sos` - 738 results  
...
`http.title:"dashboard"` - 172,137 results  
