...
`product:"Hikvision IP Camera"` - 2,861,986 results  
...
`title:"IPCam Client"` - 64,478 results  
...
`server: VVTK-HTTP-Server` - 16,804 results  
...
`port:502` - 517,690 results  


[S7](https://www.shodan.io/search?query=port%3A102)  
`port:102` - 517,105 results  
...
`port:2404 asdu address` - 3,639 results  
...
`port:20000 source address` - 1,058 results  


[PCWorx](https://www.shodan.io/search?query=port%3A1962%20PLC)  
`port:1962 PLC` - 1,058 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 434 results  
