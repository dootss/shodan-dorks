...
`title:"IPCam Client"` - 62,998 results  
...
`"in-tank inventory" port:10001` - 6,196 results  
...
`"MongoDB Server Information" port:27017` - 108,844 results  
...
`"Android Debug Bridge" "Device" port:5555` - 4,425 results  
...
`"220" "230 Login successful." port:21` - 61,628 results  
...
`hacked-router-help-sos` - 836 results  
