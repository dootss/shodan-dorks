...
`server: GeoHttpServer` - 37,494 results  
...
`port:44818` - 557,285 results  


[S7](https://www.shodan.io/search?query=port%3A102)  
`port:102` - 532,537 results  
...
`"authentication disabled" port:5900,5901` - 5,614 results  
...
`port:2404 asdu address` - 3,334 results  
...
`"Server: gSOAP/2.8" "Content-Length: 583"` - 63 results  
...
`smart install client active` - 8,431 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 577 results  
...
`http 200 server epson -upnp` - 2,044 results  
...
`http.title:"Index of /"` - 398,821 results  
...
*last updated at: 2024-02-08 20:05:54*
