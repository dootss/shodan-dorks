...
`"authentication disabled" port:5900,5901` - 6,013 results  
...
`"authentication disabled" "RFB 003.008"` - 5,638 results  
...
`Lantronix password port:30718 -secured` - 654 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 439 results  
...
`"HP-ChaiSOE" port:"80"` - 142 results  
...
`http.title:"Index of /"` - 378,426 results  
