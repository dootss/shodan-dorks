...
`200 ok dvr port:"81"` - 9,687 results  
...
`port:44818` - 556,664 results  


[S7](https://www.shodan.io/search?query=port%3A102)  
`port:102` - 532,079 results  
...
`"authentication disabled" "RFB 003.008"` - 6,625 results  
...
`"authentication disabled" port:5900,5901` - 5,572 results  
...
`mongodb port:27017` - 101,053 results  
...
`"MongoDB Server Information" port:27017` - 101,050 results  
...
`http.title:"- Polycom" "Server: lighttpd"` - 3,954 results  
...
`"dnsmasq-pi-hole" "Recursion: enabled"` - 2,671 results  
...
`"root@" port:23 -login -password -name -Session` - 1,983 results  
...
`Lantronix password port:30718 -secured` - 673 results  
...
`http.title:"dashboard"` - 121,255 results  
...
`"Minecraft Server" "protocol 340" port:25565` - 11,933 results  
...
*last updated at: 2024-02-15 05:44:13*
