...
`title:"IPCam Client"` - 58,494 results  
...
`port:1911,4911 product:Niagara` - 9,226 results  
...
`"MongoDB Server Information" port:27017` - 102,678 results  
...
`"dnsmasq-pi-hole" "Recursion: enabled"` - 2,814 results  
...
`http.title:"Index of /"` - 360,022 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 197,204 results  
...
`"220" "230 Login successful." port:21` - 62,147 results  
