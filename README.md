...
`"authentication disabled" "RFB 003.008"` - 5,809 results  
...
`port:2404 asdu address` - 3,582 results  
...
`port:9600 response code` - 1,891 results  
...
`"dnsmasq-pi-hole" "Recursion: enabled"` - 3,070 results  
...
`hacked-router-help-sos` - 784 results  
