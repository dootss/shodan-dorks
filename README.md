...
`title:"IPCam Client"` - 54,872 results  
...
`WWW-Authenticate: "Merit LILIN Ent. Co., Ltd."` - 1,122 results  
...
`port:1911,4911 product:Niagara` - 8,806 results  
...
`port:9600 response code` - 1,645 results  


[DNP3](https://www.shodan.io/search?query=port%3A20000%20source%20address)  
`port:20000 source address` - 930 results  
...
`mongodb port:27017` - 96,620 results  
...
`"MongoDB Server Information" port:27017` - 96,618 results  
...
`smart install client active` - 6,782 results  
...
`"Android Debug Bridge" "Device" port:5555` - 3,998 results  
...
`hacked-router-help-sos` - 670 results  
...
`http.title:"dashboard"` - 106,737 results  
