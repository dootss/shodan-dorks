...
`product:"Yawcam webcam viewer httpd"` - 544 results  
...
`"authentication disabled" port:5900,5901` - 6,053 results  
...
`"in-tank inventory" port:10001` - 5,901 results  
...
`port:2404 asdu address` - 3,294 results  
