...
`title:"IPCam Client"` - 58,984 results  
...
`port:1911,4911 product:Niagara` - 9,246 results  
...
`port:9600 response code` - 1,810 results  
...
`"MongoDB Server Information" port:27017` - 103,302 results  
...
`"dnsmasq-pi-hole" "Recursion: enabled"` - 2,853 results  
...
`Server: CANON HTTP Server` - 9,610 results  
...
`http.title:"Index of /"` - 363,237 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 203,015 results  
...
`hacked-router-help-sos` - 747 results  
...
`http.title:"dashboard"` - 117,915 results  
