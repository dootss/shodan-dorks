...
`"authentication disabled" port:5900,5901` - 5,660 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 7,155 results  
...
`"Minecraft Server" "protocol 340" port:25565` - 10,357 results  
