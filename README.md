...
`product:"Yawcam webcam viewer httpd"` - 649 results  
...
`webcam has_screenshot:true` - 231 results  
...
`has_screenshot:true IP Webcam` - 119 results  
...
`"authentication disabled" port:5900,5901` - 5,782 results  
...
`"authentication disabled" "RFB 003.008"` - 5,362 results  
...
`"Citrix Applications:" port:1604` - 289 results  
...
`port:23 "Password is not set"` - 409 results  
...
`http.title:"Index of /"` - 374,816 results  
