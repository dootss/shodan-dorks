...
`"authentication disabled" port:5900,5901` - 5,836 results  
...
`"authentication disabled" "RFB 003.008"` - 5,633 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 16,342 results  
...
`"root@" port:23 -login -password -name -Session` - 539 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 411 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 249,569 results  
...
`port:4444 system32` - 1,228 results  
