...
`"authentication disabled" port:5900,5901` - 5,881 results  
...
`port:5006,5007 product:mitsubishi` - 250 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 14,891 results  
