...
`200 ok dvr port:"81"` - 9,772 results  
...
`port:9600 response code` - 2,008 results  
...
`port:"9200" all:elastic` - 32,252 results  
...
`http.title:"- Polycom" "Server: lighttpd"` - 3,524 results  
...
`"HP-ChaiSOE" port:"80"` - 139 results  
...
`http.title:"dashboard"` - 349,987 results  
