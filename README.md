...
`server: GeoHttpServer` - 36,281 results  
...
`port:44818` - 556,236 results  


[S7](https://www.shodan.io/search?query=port%3A102)  
`port:102` - 532,016 results  
...
`"authentication disabled" "RFB 003.008"` - 6,604 results  
...
`port:2404 asdu address` - 3,330 results  
...
`"MongoDB Server Information" port:27017` - 100,843 results  
...
`port:"9200" all:elastic` - 31,253 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 10,695 results  


[Cisco Smart Install](https://www.shodan.io/search?query=smart%20install%20client%20active)  
`smart install client active` - 8,285 results  
...
`"dnsmasq-pi-hole" "Recursion: enabled"` - 2,665 results  
...
`Lantronix password port:30718 -secured` - 676 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 563 results  
...
`http.title:"Index of /"` - 398,643 results  
...
*last updated at: 2024-02-13 00:06:46*
