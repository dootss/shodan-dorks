...
`product:"Yawcam webcam viewer httpd"` - 619 results  
...
`port:5006,5007 product:mitsubishi` - 215 results  
...
`mongodb port:27017` - 103,571 results  
...
`port:"9200" all:elastic` - 30,607 results  
...
`"Minecraft Server" "protocol 340" port:25565` - 10,796 results  
