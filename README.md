...
`Netwave IP Camera Content-Length: 2574` - 1,307 results  
...
`"authentication disabled" "RFB 003.008"` - 5,366 results  
...
`kibana content-length:217` - 554 results  
...
`"root@" port:23 -login -password -name -Session` - 540 results  
...
`port:23 "Password is not set"` - 411 results  
...
`"Server: EPSON-HTTP" "200 OK"` - 335 results  
...
`http.title:"Index of /"` - 380,088 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 279,221 results  


[Filezilla FTP](https://www.shodan.io/search?query=filezilla%20port%3A%2221%22)  
`filezilla port:"21"` - 257,214 results  
...
`port:4444 system32` - 1,255 results  
