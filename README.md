...
`title:"blue iris remote view"` - 24 results  
...
`"in-tank inventory" port:10001` - 6,139 results  
...
`"authentication disabled" port:5900,5901` - 5,612 results  
...
`http.title:"Nordex Control" "Windows 2000 5.0 x86" "Jetty/3.1 (JSP 1.1; Servlet 2.2; java 1.6.0_14)"` - 39 results  
...
`"root@" port:23 -login -password -name -Session` - 1,979 results  
...
`http.title:"Index of /"` - 392,459 results  
...
`"QuickBooks files OverNetwork" -unix port:445` - 52 results  
...
`HACKED-ROUTER-HELP-SOS-HAD-DEFAULT-PASSWORD` - 134 results  


[Compromised FTP Servers](https://www.shodan.io/search?query=HACKED%20FTP%20server)  
`HACKED FTP server` - 85 results  
...
*last updated at: 2024-01-31 01:14:49*
