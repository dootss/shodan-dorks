...
`webcam has_screenshot:true` - 235 results  
...
`"authentication disabled" port:5900,5901` - 5,849 results  
...
`"MongoDB Server Information" port:27017` - 106,276 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 412 results  
...
`PBX "gateway console" -password port:23` - 191 results  
...
`ssl:"Xerox Generic Root"` - 363 results  
...
`"HP-ChaiSOE" port:"80"` - 168 results  
