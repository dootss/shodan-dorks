...
`"authentication disabled" port:5900,5901` - 5,670 results  
...
`port:2404 asdu address` - 3,226 results  
...
`"MongoDB Server Information" port:27017` - 100,511 results  


[Default MongoDB Instances](https://www.shodan.io/search?query=mongodb%20port%3A27017)  
`mongodb port:27017` - 100,510 results  
...
`"root@" port:23 -login -password -name -Session` - 1,871 results  
...
`title:"syncthru web service"` - 984 results  
...
`http.title:"Index of /"` - 382,886 results  
...
*last updated at: 2024-01-02 20:50:54*
