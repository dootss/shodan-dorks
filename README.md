...
`"in-tank inventory" port:10001` - 5,900 results  
...
`filezilla port:"21"` - 249,944 results  
...
`"220" "230 Login successful." port:21` - 61,653 results  
