...
`title:"IPCam Client"` - 63,009 results  
...
`"authentication disabled" "RFB 003.008"` - 5,625 results  
...
`port:2404 asdu address` - 3,539 results  
...
`mongodb port:27017` - 106,586 results  
...
`"MongoDB Server Information" port:27017` - 106,583 results  
...
`smart install client active` - 7,566 results  
...
`"Android Debug Bridge" "Device" port:5555` - 4,507 results  
...
`http.title:"Index of /"` - 377,309 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 258,337 results  


[Filezilla FTP](https://www.shodan.io/search?query=filezilla%20port%3A%2221%22)  
`filezilla port:"21"` - 257,969 results  
...
`http.title:"Hacked by"` - 504 results  
...
`http.title:"dashboard"` - 265,283 results  
