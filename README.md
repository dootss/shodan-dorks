...
`port:44818` - 522,523 results  


[S7](https://www.shodan.io/search?query=port%3A102)  
`port:102` - 513,982 results  
...
`"in-tank inventory" port:10001` - 5,647 results  
...
`"authentication disabled" port:5900,5901` - 4,987 results  
...
`"Siemens, SIMATIC" port:161` - 2,855 results  
...
`port:20000 source address` - 894 results  


[PCWorx](https://www.shodan.io/search?query=port%3A1962%20PLC)  
`port:1962 PLC` - 857 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 6,787 results  
...
`"root@" port:23 -login -password -name -Session` - 1,041 results  
...
`kibana content-length:217` - 583 results  
...
`title:"syncthru web service"` - 898 results  
...
*last updated at: 2024-03-19 02:45:59*
