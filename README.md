...
`server: GeoHttpServer` - 36,386 results  
...
`"authentication disabled" port:5900,5901` - 4,932 results  
...
`port:9600 response code` - 1,690 results  
...
`port:"9200" all:elastic` - 29,310 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 6,585 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 164,766 results  


[Open Lists on Port 80](https://www.shodan.io/search?query=port%3A80%20title%3A%22Index%20of%20/%22)  
`port:80 title:"Index of /"` - 140,191 results  
...
`http.title:"control panel"` - 60,580 results  
...
*last updated at: 2024-03-26 17:58:34*
