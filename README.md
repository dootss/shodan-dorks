...
`webcam has_screenshot:true` - 219 results  
...
`port:44818` - 547,967 results  


[S7](https://www.shodan.io/search?query=port%3A102)  
`port:102` - 518,696 results  
...
`"authentication disabled" "RFB 003.008"` - 5,567 results  
...
`port:5006,5007 product:mitsubishi` - 243 results  
...
`http.title:"- Polycom" "Server: lighttpd"` - 3,604 results  
...
`"root@" port:23 -login -password -name -Session` - 594 results  
...
`"HP-ChaiSOE" port:"80"` - 155 results  
...
`http.title:"Index of /"` - 374,986 results  
