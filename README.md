...
`port:2404 asdu address` - 3,098 results  
...
`"MongoDB Server Information" port:27017` - 97,976 results  


[Default MongoDB Instances](https://www.shodan.io/search?query=mongodb%20port%3A27017)  
`mongodb port:27017` - 97,971 results  
...
`"Android Debug Bridge" "Device" port:5555` - 4,060 results  
...
`"root@" port:23 -login -password -name -Session` - 485 results  
...
`http 200 server epson -upnp` - 1,893 results  
...
`"220" "230 Login successful." port:21` - 58,800 results  
...
`http.title:"dashboard"` - 107,711 results  
