...
`webcam has_screenshot:true` - 226 results  
...
`"authentication disabled" port:5900,5901` - 5,773 results  
...
`"authentication disabled" "RFB 003.008"` - 5,319 results  
...
`"HID VertX" port:4070` - 193 results  
...
`"Server: gSOAP/2.8" "Content-Length: 583"` - 40 results  
...
`Lantronix password port:30718 -secured` - 639 results  
...
`"Citrix Applications:" port:1604` - 288 results  
...
`http.title:"Index of /"` - 371,917 results  
