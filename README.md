...
`WWW-Authenticate: "Merit LILIN Ent. Co., Ltd."` - 1,227 results  
...
`"authentication disabled" port:5900,5901` - 5,807 results  
...
`"authentication disabled" "RFB 003.008"` - 5,738 results  
...
`"Siemens, SIMATIC" port:161` - 3,037 results  


[Omron FINS](https://www.shodan.io/search?query=port%3A9600%20response%20code)  
`port:9600 response code` - 1,861 results  
...
`"Polycom Command Shell" -failed port:23` - 32 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 226,964 results  
...
`hacked-router-help-sos` - 773 results  
...
`http.title:"dashboard"` - 197,243 results  
...
`"Minecraft Server" "protocol 340" port:25565` - 11,109 results  
