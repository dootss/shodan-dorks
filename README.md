...
`"authentication disabled" port:5900,5901` - 6,022 results  
...
`"authentication disabled" "RFB 003.008"` - 5,611 results  
...
`port:5006,5007 product:mitsubishi` - 245 results  
...
`Lantronix password port:30718 -secured` - 653 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 441 results  
...
`"Location: /main/main.html" debut` - 72 results  
...
`http.title:"Index of /"` - 377,019 results  
...
`HACKED-ROUTER-HELP-SOS-HAD-DEFAULT-PASSWORD` - 103 results  
...
`http.title:"0wn3d by"` - 10 results  
