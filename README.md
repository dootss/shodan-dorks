...
`port:9600 response code` - 1,916 results  
...
`port:"9200" all:elastic` - 31,745 results  
...
`port:80 title:"Index of /"` - 152,359 results  
...
`"Minecraft Server" "protocol 340" port:25565` - 10,988 results  
