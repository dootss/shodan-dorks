...
`"authentication disabled" "RFB 003.008"` - 5,571 results  
...
`"root@" port:23 -login -password -name -Session` - 559 results  
...
`http.title:"Index of /"` - 377,190 results  
...
`filezilla port:"21"` - 257,415 results  
