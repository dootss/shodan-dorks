...
`"authentication disabled" port:5900,5901` - 6,060 results  
...
`port:2404 asdu address` - 3,651 results  
...
`"DICOM Server Response" port:104` - 1,884 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 14,833 results  
...
`Lantronix password port:30718 -secured` - 658 results  
...
`PBX "gateway console" -password port:23` - 220 results  
...
`Server: CANON HTTP Server` - 10,265 results  
...
`http.title:"Index of /"` - 380,581 results  
...
`port:80 title:"Index of /"` - 154,955 results  
...
`"Anonymous access allowed" port:"21"` - 33,848 results  
...
`port:4444 system32` - 1,230 results  
