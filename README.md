...
`"authentication disabled" port:5900,5901` - 5,745 results  
...
`"authentication disabled" "RFB 003.008"` - 5,546 results  
...
`"dnsmasq-pi-hole" "Recursion: enabled"` - 3,077 results  
...
`"Set-Cookie: mongo-express=" "200 OK"` - 426 results  
...
`ssl:"Xerox Generic Root"` - 345 results  
...
`"HP-ChaiSOE" port:"80"` - 165 results  
...
`http.title:"Index of /"` - 379,291 results  
...
`hacked-router-help-sos` - 804 results  
