...
`product:"Hikvision IP Camera"` - 2,812,446 results  
...
`server: VVTK-HTTP-Server` - 16,583 results  
...
`has_screenshot:true IP Webcam` - 118 results  
...
`port:2404 asdu address` - 3,572 results  
...
`port:20000 source address` - 1,113 results  
...
`hacked-router-help-sos` - 842 results  
