...
`200 ok dvr port:"81"` - 9,722 results  
...
`Netwave IP Camera Content-Length: 2574` - 1,391 results  
...
`port:44818` - 504,388 results  


[S7](https://www.shodan.io/search?query=port%3A102)  
`port:102` - 481,595 results  
...
`"in-tank inventory" port:10001` - 6,146 results  
...
`port:2455 operating system` - 35 results  
...
`"X-Jenkins" "Set-Cookie: JSESSIONID" http.title:"Dashboard"` - 1,231 results  
...
`Lantronix password port:30718 -secured` - 742 results  
...
`http.title:"Index of /"` - 379,077 results  
...
*last updated at: 2023-12-07 11:17:05*
