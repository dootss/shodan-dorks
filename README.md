...
`server: VVTK-HTTP-Server` - 16,527 results  
...
`"authentication disabled" "RFB 003.008"` - 5,420 results  
...
`port:20000 source address` - 1,010 results  
...
`http.title:"Index of /"` - 379,579 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 262,212 results  


[Filezilla FTP](https://www.shodan.io/search?query=filezilla%20port%3A%2221%22)  
`filezilla port:"21"` - 257,217 results  
...
`http.title:"control panel"` - 66,197 results  
