...
`product:"Hikvision IP Camera"` - 2,801,417 results  
...
`title:"IPCam Client"` - 63,432 results  
...
`"MongoDB Server Information" port:27017` - 109,203 results  
...
`http 200 server epson -upnp` - 2,401 results  
...
`"Authentication: disabled" port:445 product:"Samba"` - 299,860 results  


[Filezilla FTP](https://www.shodan.io/search?query=filezilla%20port%3A%2221%22)  
`filezilla port:"21"` - 255,653 results  
...
`"220" "230 Login successful." port:21` - 61,925 results  
