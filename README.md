...
`port:9600 response code` - 1,939 results  
...
`port:"9200" all:elastic` - 32,047 results  
...
`"dnsmasq-pi-hole" "Recursion: enabled"` - 2,943 results  
...
`"Minecraft Server" "protocol 340" port:25565` - 11,183 results  
